...
//     do {
//         producto = prompt('¿Quieres comprar inciensos, velas, aceites esenciales o adornos?');

//         if (producto) {
//             cantidad = Number(prompt('¿Cuántos quieres comprar?'));
...
//                     break;
//                 default:
//                     alert('El producto no se encuentra en nuestro catálogo. Intenta con otra palabra');
//                     precio = 0;
//                     cantidad = 0;
//             }
...
// ****OTRO EJEMPLO PARA LA SEGUNDA PRE ENTREGA*****
...
comprar();
    ...
    //  do {
    //      let producto = prompt('¿Quieres comprar inciensos, velas, aceites esenciales o adornos?');

//         if (producto) {
//             producto = producto.toLowerCase();
//             const productoEnCatalogo = catalogo.find(item => item.producto === producto);

//             if (productoEnCatalogo) {
//                 let cantidad = Number(prompt('¿Cuántos quieres comprar?'));
//                 if (cantidad > 0) {
//                     carrito.push({ producto, cantidad });
//                     subtotal += productoEnCatalogo.precio * cantidad;

//                     console.log(`Producto: ${producto}`);
//                     console.log(`Cantidad: ${cantidad}`);
//                     console.log(`Precio unitario: ${productoEnCatalogo.precio}`);
//                     console.log(`Subtotal: ${subtotal}`);
//                 } else {
